...
w launcherze). Na VPS: `sh linux-port/tools/update.sh`. Bez nowego klienta
wejście do Groty Wygnańców albo do Diabelskich Katakumb zamyka grę.
Zawiera wszystko z 2.2.21.

Ta wersja przenosi na naszą 2.2.21 wersję 2.2.21 projektu źródłowego (serwer)
...
- Po wejściu do Groty klient się zamykał, a postaci zapisanej w Grocie
  ...
  Klient 2.0.39 ma obie Groty tam, gdzie klient ich szuka, i mapę
  Katakumb z oryginalnego klienta gry. Wszystkie obiekty, tekstury i
  potwory tych map klient już miał.
- Przy pierwszym starcie 2.2.22 serwer jednorazowo przenosi postacie
...
- Portal z 2.2.21 wpuszczał do Groty każdego za darmo. Teraz jest jak
...
- „Could not re-equip” przy bonowaniu (SIZOWSKI): bot zdejmował
  ...
  własnym ciosie albo umiejętności nie pozwalała go założyć. 2.2.21
...
- Poprawka z 2.2.21 odblokowująca Kamień Duchowy i Wykrywacz Kamieni
...
Ta wersja przenosi na naszą 2.2.15 wersję 2.2.15 projektu źródłowego. Zostaje
wszystko, co dodaliśmy wcześniej: okno zmiany bonusów pod klawiszem U,
wierzchowce z pieczęci w ItemShopie, hostowanie w COOP bez hasła i linki do
...
Serwer 2.2.15 i klient 2.0.36. Zaktualizuj oba („AKTUALIZUJ wszystko”
w launcherze): nowy klient ma okno towarzysza pod klawiszem P i dwa nowe
przyciski na pasku. Na VPS: `sh linux-port/tools/update.sh`.

Ta wersja przenosi na naszą 2.2.13 zmiany z wersji 2.2.13 i 2.2.14 projektu
źródłowego: Towarzysza (stałego kompana gracza) z jego oknem, rajdy botów na
bossów świata, umiejętności zatrzymujące się na 17 punktach, Wieżę Demonów od
55 poziomu, serwer na VPS z launchera i przełączniki Auto Łowów i Towarzysza.
Zostaje wszystko, co dodaliśmy wcześniej: okno zmiany bonusów pod klawiszem U,
wierzchowce z pieczęci w ItemShopie, hostowanie w COOP bez hasła (także
zaproszenia na VPS) i linki do naszego repozytorium.

### Boty biją bossów (zgłosił prodnathin)
...
### Przyciski na pasku (klient 2.0.36)
...
### Auto Łowy i Towarzysz do wyłączenia na serwerze (pomysł Drip)
...
- Z wyłączonymi Auto Łowami klient (od 2.0.36) zatrzymuje polowanie i pisze na czacie,
...
### Towarzysz — Twój stały kompan (nowość, do testów)
...
### Zwoje na broń od 30 poziomu (Iwakura)
...
Poprawki na podstawie prawdziwych rozmów graczy z botami:
...
- **Serwer na VPS (nowość, eksperymentalne; po pytaniu Sudaka
  ...
  Zaproszenia dla znajomych działają jak w COOP i, jak całe COOP u nas,
  nie wymagają hasła. Nie
...
przy starcie albo po kliknięciu SPRAWDŹ AKTUALIZACJE. Na VPS:
`sh linux-port/tools/update.sh`.

Ta wersja przenosi na naszą 2.2.8 zmiany z wersji 2.2.8 projektu źródłowego:
hazardzista znowu trzyma swoje bazy do ulepszania, a boty na próbie konia
bojowego idą do łuczników na pustyni. Zostaje wszystko, co dodaliśmy
wcześniej: wierzchowce z pieczęci w ItemShopie, hostowanie w COOP bez hasła
i linki do naszego repozytorium.

### Hazardzista znowu trzyma swoje bazy (Iwakura)
...
Ta wersja przenosi na naszą 2.2.7 zmiany z wersji 2.2.7 projektu źródłowego
(u nich z klientem 2.0.29): Metiny z konia bojowego, łucznicy w Wieży
strzelający z daleka, wojny gildii z celami rozłożonymi na przeciwników,
magazyny botów opróżniane z niepotrzebnego sprzętu, boty zmieniające kanały,
nowe szepty („chodź do mnie”, ścieżka, buffy szamana), Szybki Atak w Auto
Łowach bez wyrzucania postaci poza świat i szybsze sprawdzanie aktualizacji
w launcherze. Opis poniżej. Zostaje wszystko, co dodaliśmy wcześniej:
wierzchowce z pieczęci w ItemShopie, hostowanie w COOP bez hasła i linki do
naszego repozytorium.
...
### Metiny z konia bojowego (zgłosił prodnathin)
...
### Łucznicy w Wieży Demonów (prodnathin)
...
### Wojny gildii: każdy bije swój cel (prodnathin)
...
### Magazyny i księgi (zgłosił GorącyDelfin)
...
Serwer 2.2.7 i klient 2.0.31. W launcherze ZAINSTALUJ AKTUALIZACJE, potem
AKTUALIZUJ KLIENTA (albo „AKTUALIZUJ wszystko”). Na VPS:
`sh linux-port/tools/update.sh`.

Ta wersja przenosi na naszą 2.1.5 wszystkie zmiany z projektu źródłowego,
z jego wersji od 2.2.0 do 2.2.6: nową mapę dla botów (Doyyumhwaji), po 1500
botów w każdym królestwie, poprawki Wieży Demonów, bonusy nakładane na jeden
przedmiot naraz, Listę Przydatnych Przedmiotów tylko dla Hazardzisty, tarcze
i zbroje wybierane po liczbach, medale konne na straganach po 2 sztuki,
statusy botów po angielsku w kliencie ustawionym na inny język, wyszukiwarkę
sklepów z jednym klikniętym przedmiotem, Auto Łowy bijące najbliższego
potwora, opisy w oknie liczby botów w launcherze i aktualne poziomy botów
w panelach. Sekcje od 2.2.6 do 2.2.0 poniżej opisują je tak, jak wyszły tam;
numery klienta w nich (2.0.26–2.0.28) to numeracja projektu źródłowego,
u nas te zmiany są w kliencie 2.0.31.

Zostaje wszystko, co dodaliśmy od 2.1.1: wierzchowce z pieczęci w ItemShopie
(zakładka Wierzchowce, jazda i bonusy jeźdźca), hostowanie w COOP bez hasła
i linki do naszego repozytorium.
...
### Wieża Demonów: poprawki z listy prodnathina (zgłosił prodnathin)
...
### Launcher: język gry po angielsku
...
### Tarcza i zbroja: decydują liczby, a nie poziom przedmiotu (wyjaśnił Iwakura)
...
### Medale konne na straganach po 2 sztuki
...
### Launcher: opisy w oknie liczby botów
...
### Magazyny pełne zbroi: Lista Przydatnych Przedmiotów tylko dla Hazardzisty (wyjaśnił Iwakura)
