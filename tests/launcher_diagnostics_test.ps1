...
$cases = @(
    ...
    [pscustomobject]@{
        ...
        Text = 'Nie udalo sie pobrac https://raw.githubusercontent.com/Doofenyoyo1/metin2_SP/main/update-manifest-mt2009.json: Serwer zdalny zwrócił błąd: (404) Nie znaleziono.'
