...
"@
    ...
    # COOP is not gated in this repository, so neither are the VPS invites:
    # a root that never saw any password may make them.
    Check 'invites are open to everybody' (Test-M2VpsInviteAccess -ServerRoot $gate)
